...
let whoHasHammer = VISITOR_COLOUR // Who has the hammer in an end
...
let hasRole = false // true when the client is either a player or a spectator
let updated = false // checks if new users have the correct stone positions
